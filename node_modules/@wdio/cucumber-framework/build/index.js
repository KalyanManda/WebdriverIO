    ...
    addWdioHooks(config) {
        ...
        Cucumber.AfterStep(async function wdioHookAfterStep(world) {
            ...
            let result = {
                ...
                'duration': (_c = world.result) === null || _c === void 0 ? void 0 : _c.duration
            };
            await utils_1.executeHooksWithArgs('afterStep', config.afterStep, [params === null || params === void 0 ? void 0 : params.step, params === null || params === void 0 ? void 0 : params.scenario, result]);
        });
    }
    /**
